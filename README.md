...
La API Key se guarda en `js/config.js`, que está configurado en `.gitignore`:

- ✅ No aparece en el repositorio de GitHub
- ✅ Cada desarrollador tiene su propia clave local
- ✅ Para producción, usar variables de entorno en el hosting
...
Configura Pages desde Settings → Pages → Deploy from branch
...
- Abre `js/config.js` y verifica que la API Key está correcta

### Error: "Ciudad no encontrada"
- Verifica la ortografía del nombre de la ciudad
- Intenta con ciudades más conocidas primero

### Error: "Conexión rechazada"
- Asegúrate que el servidor está ejecutándose: `npm start`
- Verifica que estás en http://localhost:8000

### Error: "No secure"
- Es normal en desarrollo local
- En producción (HTTPS) desaparecerá
